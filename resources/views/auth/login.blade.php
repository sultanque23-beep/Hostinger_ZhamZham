<x-guest-layout>
    ...
    <div class="mb-6 text-center">
        <h2 class="text-2xl font-bold text-gray-800">Grosir ZhamZham</h2>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-6">
            <x-primary-button class="w-full justify-center py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-lg transition">
                {{ __('Masuk Ke Sistem') }}
            </x-primary-button>
        </div>
    </form>
